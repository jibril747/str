		...
		<div class="row tm-main-row">
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
					...
					<section id="tm-section-1" class="tm-section">
						<div class="ml-auto">
							<header class="mb-4"><h1 class="tm-text-shadow"><font color="black"> Sistem Informasi Surat Tanda Registrasi (STR)</font></h1></header>
							<span>
							</span>
								<span>
								</span>
							<header class="mb-2"><h3 class="tm-text-shadow">Silahkan Masuk Ke Sistem</h3></header>
							<form action="check_login.php" method="post">
								...
								<button type="submit" class="btn tm-btn-submit tm-btn">Login</button>
							</form>
