		...
		<div class="row tm-main-row">
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
					...
					<section id="tm-section-1" class="tm-section">
						<div class="ml-auto">
							<header class="mb-4"><h1 class="tm-text-shadow">Tambah Data Baru</h1></header>
...
<tr>
	<td class="td-form">Status</td>
		<td class="td-form">
			
			<select name="jenis_akun" id="jenis_akun" class="select-form" required>
	...
	<tr>
      ...
      <td class="td-form"><input type="text" name="username" class="td-select-form" value="" /></td>
    </tr>
    <tr>
      <td class="td-form">Password</td>
      <td class="td-form"><input type="Password" name="password" class="td-select-form" value="" /></td>
    </tr>
	<tr>
      <td class="td-form">NIP</td>
      <td class="td-form"><input type="text" name="NIP" class="td-select-form" value="" /></td>
    </tr>
	<tr>
		<td class="td-form">Nama Pegawai</td>
		<td class="td-form"><input type="text" name="nama_pegawai" class="td-select-form" value="" required placeholder="Nama"/></td>
	</tr>
	<tr>
		<td class="td-form">Nomor STR</td>
		<td class="td-form"><input type="text" name="nomor_STR" class="td-select-form" value="" required placeholder="Nomor STR"/>
		</td>
	</tr>
	<tr>
		<td>Masa Berlaku STR </td>
        <td><div class="td-form">
          <input type="text" name="akhir_STR" id="akhir_STR" class="td-select-form" value="" required placeholder="Tanggal Berlaku STR"/>
        </div></td>
        <tr>
